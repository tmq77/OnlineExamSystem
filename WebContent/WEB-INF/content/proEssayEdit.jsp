		...
		<c:forEach items="${proEssay}" var="Info" varStatus="vs">
			<div class="proEssayBlock">
				<div
					...
					<a href="#" style="color: #4296E0" class="removepro"
						id="d_${Info.essayId}"> <span
						class="glyphicon glyphicon-remove"></span>
					</a>
				</div>
				<div
					style="width: 8%; float: right; font-size: 12px; text-align: center;">
					<a href="#" style="color: #4296E0" class="modifypro"
						id="u_${Info.essayId}"><span class="glyphicon glyphicon-cog"></span></a>
				</div>
				<div style="width: 100%; float: left;">${Info.etitle}</div>
				<input type="hidden" value="${Info.eright}" id="pro_${Info.essayId}">
				<input type="hidden" value="${Info.etitle}"
					id="title_${Info.essayId}">
			</div>
		</c:forEach>
	</div>
